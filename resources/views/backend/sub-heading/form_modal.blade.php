    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-body">
                    <form class="row g-3 form" id="dataForm" action="{{ route('sub-headings.store') }}">
                        <input type="hidden" id="id" name="id" value="">
                        <div class="col-md-12">
                            <label for="heading_id" class="form-label">Heading </label>
                            <select id="heading_id" class="form-select" name="heading_id">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="name"
                                placeholder="Enter Sub Heading Name" name="name" required>
                        </div>
