    ...
    <div class="modal-dialog  modal-dialog-scrollable  modal-xl">
        <div class="modal-content modal-lg">
            ...
            <div class="modal-body">
                <form class="row g-3 form" id="dataForm" action="{{ route('retail-groups.store') }}">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="form-check form-switch appendLimit mt-3">
                                                            <input class="form-check-input limit_check"
                                                                type="checkbox" value="Y" name="limit_check"
                                                                id="limit_check{{$heading->id}}">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-check form-check-info">
                                                            <input type="hidden" name="is_employee[{{ $heading->id }}]" value="N">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Y" name="is_employee[{{ $heading->id }}]" checked>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-check form-check-info">
                                                            <input type="hidden" name="is_spouse[{{ $heading->id }}]" value="N">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Y" name="is_spouse[{{ $heading->id }}]">
                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-check form-check-info">
                                                            <input type="hidden" name="is_child[{{ $heading->id }}]" value="N">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Y" name="is_child[{{ $heading->id }}]">
                                                            <label class="form-check-label"
                                                    ...
                                                    <!-- Parent Checkbox -->
                                                    <div class="col-md-2">
                                                        <input type="hidden" name="is_parent[{{ $heading->id }}]" value="N">
                                                        <div class="form-check form-check-info">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="Y" name="is_parent[{{ $heading->id }}]">
                                                            <label class="form-check-label"
                                                ...
                                                <div class="row sub_headingRow">
                                                    ...
                                                    @foreach ($heading->sub_headings as $subheading)
                                                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 subLimitRow">
                                                            ...
                                                            <div class="mb-3 mt-3 appendAccessType col-md-11" id="accessDiv{{$subheading->id}}">
