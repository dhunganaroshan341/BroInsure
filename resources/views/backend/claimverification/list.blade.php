        ...
        <div class="card-body">
            <div class="row" id="filterData">
                ...
                @if (str_contains(request()->path(), 'claimverification'))
                    <div class="form-group col-md-4 mb-2">
                        <div class="form-group row">
                            <label class="labelsmaller col-sm-4" for="claim_id">Claim Id:</label>
                            <div class="col-sm">
                                <select id="claim_id" data-required="true" class="labelsmaller form-select form-select-sm"
                                    name="claim_id">
                                    <option value="" selected="">Claim Id
                                    </option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="row register_container  d-flex flex-row-reverse justify-content-center d-none">
