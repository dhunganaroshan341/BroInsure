    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-body">
                    <form class="row g-3 policyForm" id="PolicydataForm" action="{{ route('client-policies.store') }}">
                        <input type="hidden" id="policy_id" name="policy_id" value="">
                        <input type="hidden" id="client_id" name="client_id" value="">
                        <div class="row">

                            <div class="col-md-6">
                                <label for="code" class="form-label">Policy Number <span
                                        class="text-danger">*</span>:</label>
                                <input type="text" class="form-control" id="policy_no"
                                    placeholder="Policy Number"name="policy_no" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="code" class="form-label">Number Of Employee <span
                                        class="text-danger">*</span>:</label>
                                <input type="number" min="1" class="form-control" id="member_no"
                            ...
                            <div class="col-md-6">
                                <label for="code" class="form-label">Premium Amount : </label>
                                <input type="number" min="0" class="form-control" id="premium_amount"
                                    placeholder="Enter Premium Amount" name="premium_amount">
                            </div>
                            <div class="col-md-6">
                                <label for="code" class="form-label">Insured Amount : </label>
                                <input type="number" min="0" class="form-control" id="insured_amount"
                                    placeholder="Enter Insured Amount" name="insured_amount">
                            </div>
                            <div class="col-md-6 ">
                                ...
                                <label for="excess_value" class="form-label">Excess<span
                                        class="text-danger">*</span>:</label>
                                <input type="number" min="0" class="form-control" id="excess_value"
